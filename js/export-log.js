...
$(function() {
    ...
    var percentage = Math.round(100 * total_exported / output_rows);
    ...
    $('#logDetailsTable').bootstrapTable({
        url:                '?action=getLogDetails&id=' + id_log + '&type=export',
        method:             'get', // get, post
...
*/
    ...
    $('#btn-download-file, #btn-download-settings, #btn-download-details').click(function(e) {
        e.preventDefault();
        $('#downloadFrame').attr('src', "actions.php?action=export_download&id=" + id_log + '&filename=' + $(this).data('filename'));
    });
