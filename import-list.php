        ...
        <div class="panel clearfix">
            <div class="panel-body">
                ...
                <div id="toolbar" class="btn-group hidden-xs ng-scope" role="group">
                    <a href="import.php" title="New" class="btn btn-default" data-tooltip="true">
                ...
                <table id="importsTable" class="bs-table">
                    <thead>
                        <tr>
                            ...
                            <th data-field="total_imported" class="total_imported" data-formatter="totalImportedFormatter" data-sortable="true" data-align="right" title="Imported" data-width="130">Imported</th>
                            ...
                            <th data-field="total_skipped" class="text-info" data-sortable="true" data-align="right" title="Skipped" data-width="75" data-visible="false">Skipped</th>
                            <th data-field="total_inserted" class="text-success" data-sortable="true" data-align="right" title="Inserted" data-width="75" data-visible="false">Inserted</th>
                            <th data-field="total_updated" class="text-primary" data-sortable="true" data-align="right" title="Updated" data-width="75" data-visible="false">Updated</th>
                            <th data-field="total_deleted" class="text-warning" data-sortable="true" data-align="right" title="Deleted" data-width="75" data-visible="false">Deleted</th>
                            <th data-field="total_error" class="text-danger" data-sortable="true" data-align="right" title="Error" data-width="75" data-visible="false">Error</th>
                            ...
                            <th data-field="time_elapsed" data-formatter="timeElapsedFormatter" data-sortable="true" data-width="105" data-align="right" data-visible="false">Time Elapsed</th>
                            <th data-field="status" data-sortable="true" data-width="100">Status</th>
                            <th data-field="actions" data-formatter="actionsFormatter" data-events="actionsEvents" data-width="110" data-halign="center" data-align="center" style="white-space: nowrap;">Actions</th>
                        </tr>
                    </thead>
                </table>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <div class="col-sm-6">
                        <table class="log_table">
                            <tbody>
                                ...
                                <tr id="settings_duplicates" class="space">
                                    <td>Field that defines a duplicate: </td>
                                    <td></td>
                                </tr>
                                <tr id="settings_actions_duplicates">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p id="settings_actions_rest_create">Create new records from data newly present in your file</p>
                                        <p id="settings_actions_rest_delete">Delete records that are no longer present in your file</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="modal-footer">
                    <!--<button type="button" class="btn btn-sm btn-outline-primary">New Import with this settings</button>-->
                </div>
            </div>
        </div>
    </div>
